...
public:
   ...
   */
  virtual std::optional<plansys2_msgs::msg::Node> getPredicate(const std::string & predicate)
  = 0;
   ...
   */
  virtual std::optional<plansys2_msgs::msg::Node> getFunction(const std::string & function) =
  0;
