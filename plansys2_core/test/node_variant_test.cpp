...
TEST(types_test, node_variant_equality)
{
  ...
  ASSERT_EQ(
    std::hash<plansys2::NodeVariant>{}(nv_predA_var_a),
    std::hash<plansys2::NodeVariant>{}(nv_predA_var_a));
  ASSERT_EQ(
    std::hash<plansys2::NodeVariant>{}(nv_predA_var_a),
    std::hash<plansys2::NodeVariant>{}(nv_predA_var_x));
  ASSERT_EQ(
    std::hash<plansys2::NodeVariant>{}(nv_predA_var_a),
    std::hash<plansys2::NodeVariant>{}(nv_predA_const_a));
  ASSERT_EQ(
    std::hash<plansys2::NodeVariant>{}(nv_predA_var_a),
    std::hash<plansys2::NodeVariant>{}(nv_predA_const_b));
  ASSERT_EQ(
    std::hash<plansys2::NodeVariant>{}(nv_predA_const_a),
    std::hash<plansys2::NodeVariant>{}(nv_predA_var_a));
  ASSERT_EQ(
  ...
  ASSERT_NE(
    std::hash<plansys2::NodeVariant>{}(nv_predA_var_a),
    std::hash<plansys2::NodeVariant>{}(nv_predA_2_vars));
  ...
  ASSERT_NE(
    std::hash<plansys2::NodeVariant>{}(nv_inferredA),
    std::hash<plansys2::NodeVariant>{}(nv_inferredAconstant));
  ...
  auto nv_inferred_function_design_fd_better =
    plansys2::NodeVariant(inferred_function_design_fd_better);
  auto nv_inferred_function_design_fd_better_inverse =
    plansys2::NodeVariant(inferred_function_design_fd_better_inverse);
  ...
  ASSERT_NE(
    std::hash<plansys2::NodeVariant>{}(nv_inferred_function_design_fd_better),
    std::hash<plansys2::NodeVariant>{}(nv_inferred_function_design_fd_better_inverse));
  ...
  ASSERT_EQ(
    std::hash<plansys2::NodeVariant>{}(nv_inferredAB),
    std::hash<plansys2::NodeVariant>{}(nv_inferredABi));
}
