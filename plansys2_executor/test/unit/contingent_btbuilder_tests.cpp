...
TEST(simple_btbuilder_tests, test_tree_builder)
{
  ...
  pluginlib::ClassLoader<plansys2::PlanSolverBase> plan_loader(
  ...
  pluginlib::ClassLoader<plansys2::BTBuilder> btbuilder_loader(
  ...
  std::string expected_tree(
    (std::istreambuf_iterator<char>(expected_tree_ifs)), std::istreambuf_iterator<char>());
