...
/**
 * @class plansys2::CheckAction
 * @brief BehaviorTree node that checks if an action can be executed.
 */
class CheckAction : public BT::ActionNodeBase
{
public:
  /**
   * @brief Constructor for the CheckAction node.
   *
   ...
   */
  CheckAction(const std::string & xml_tag_name, const BT::NodeConfig & conf);
