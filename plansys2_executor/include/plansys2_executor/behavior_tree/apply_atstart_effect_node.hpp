...
/**
 * @class plansys2::ApplyAtStartEffect
 * @brief BehaviorTree node that applies the at-start effects of a durative action.
 */
class ApplyAtStartEffect : public BT::ActionNodeBase
{
public:
  /**
   * @brief Constructor for the ApplyAtStartEffect node.
   *
   ...
   */
  ApplyAtStartEffect(const std::string & xml_tag_name, const BT::NodeConfig & conf);
