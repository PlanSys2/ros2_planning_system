...
/**
 * @class plansys2::CheckAtEndReq
 * @brief BehaviorTree node that checks the at-end requirements of a durative action.
 */
class CheckAtEndReq : public BT::ActionNodeBase
{
public:
  /**
   * @brief Constructor for the CheckAtEndReq node.
   *
