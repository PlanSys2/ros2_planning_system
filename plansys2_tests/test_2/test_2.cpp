...
TEST(test_2, test_2)
{
  ...
  domain_node->set_parameter({"model_file", pkgpath.string() + "/test_2/pddl/test_2.pddl"});
  problem_node->set_parameter({"model_file", pkgpath.string() + "/test_2/pddl/test_2.pddl"});
