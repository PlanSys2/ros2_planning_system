...
TEST(test_1, test_1)
{
  ...
  domain_node->set_parameter({"model_file", pkgpath.string() + "/test_1/pddl/test_1.pddl"});
  problem_node->set_parameter({"model_file", pkgpath.string() + "/test_1/pddl/test_1.pddl"});
