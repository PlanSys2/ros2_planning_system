...
TEST(test_4, test_4)
{
  ...
  domain_node->set_parameter({"model_file", pkgpath.string() + "/test_4/pddl/test_4.pddl"});
  problem_node->set_parameter({"model_file", pkgpath.string() + "/test_4/pddl/test_4.pddl"});
