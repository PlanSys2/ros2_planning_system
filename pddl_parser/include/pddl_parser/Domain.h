...
#pragma once
  ...
  #include "pddl_parser/Task.h"
  #include "pddl_parser/TemporalAction.h"
  #include "pddl_parser/And.h"
  #include "pddl_parser/Derived.h"
  #include "pddl_parser/Equals.h"
  #include "pddl_parser/Exists.h"
  #include "pddl_parser/Forall.h"
  #include "pddl_parser/Function.h"
  #include "pddl_parser/GroundFunc.h"
  #include "pddl_parser/FunctionModifier.h"

  #include "pddl_parser/Not.h"
  #include "pddl_parser/Oneof.h"
  #include "pddl_parser/Or.h"
  #include "pddl_parser/EitherType.h"
  #include "pddl_parser/When.h"
