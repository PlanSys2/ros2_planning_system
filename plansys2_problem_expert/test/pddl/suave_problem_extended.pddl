(define (problem example-auv)
  ...
  (:objects 
    pipeline - pipeline 
    0.0_decimal 0.5_decimal 0.75_decimal 1.25_decimal 2.25_decimal 3.25_decimal - numerical-object 
)

  (:init
    (qa_has_value obs_battery_level 0.0_decimal)
    ...
    (Function generate_recharge_path)
    ...
    (FunctionDesign normal)
    (QAvalue obs_battery_level)
    ...
    (isQAtype obs_battery_level battery_level)
    ...
    (requiresF a_recharge_battery f_maintain_motion)
    (requiresF a_recharge_battery generate_recharge_path)
    ...
    (solvesF normal generate_recharge_path)
  )
