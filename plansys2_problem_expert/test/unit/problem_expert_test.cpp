...
TEST(problem_expert, addget_instances)
{
  ...
  ASSERT_FALSE(problem_expert.addInstance(parser::pddl::fromStringParam("Paco", "SCIENTIFIC")));
...
TEST(problem_expert, add_functions)
{
  ...
  ASSERT_TRUE(
    problem_expert.addInstance(parser::pddl::fromStringParam("kitchen", "room_with_teleporter")));
...
TEST(problem_expert, addget_predicates)
{
  ...
  ASSERT_TRUE(
    problem_expert.addInstance(parser::pddl::fromStringParam("bathroom", "room_with_teleporter")));
...
TEST(problem_expert, addget_unknown_predicates)
{
  ...
  auto oneof_1 =
    parser::pddl::fromString("(oneof (person_at paco kitchen) (person_at paco bedroom))");
  ...
  predicate_5_invalid.node_type = plansys2_msgs::msg::Node::PREDICATE;
  predicate_5_invalid.name = "person_at";
  predicate_5_invalid.parameters.push_back(parser::pddl::fromStringParam("paco", "person"));
  predicate_5_invalid.parameters.push_back(parser::pddl::fromStringParam("kitchen", "room"));
  predicate_5_invalid.parameters.push_back(parser::pddl::fromStringParam("r2d2", "robot"));
  predicate_5_invalid.parameters.push_back(parser::pddl::fromStringParam("bedroom", "room"));

  plansys2_msgs::msg::Node predicate_6_invalid;
  predicate_6_invalid.node_type = plansys2_msgs::msg::Node::PREDICATE;
  predicate_6_invalid.name = "person_at";
  predicate_6_invalid.parameters.push_back(parser::pddl::fromStringParam("kitchen", "room"));
  predicate_6_invalid.parameters.push_back(parser::pddl::fromStringParam("paco", "person"));
...
TEST(problem_expert, addget_goals)
{
  ...
  ASSERT_EQ(
    parser::pddl::toString(goal2), "(and (robot_at r2d2 bedroom)(not (person_at paco kitchen)))");
  ...
  ASSERT_EQ(
    parser::pddl::toString(goal3), "(and (robot_at r2d2 bedroom)(not (person_at paco kitchen)))");
...
TEST(problem_expert, get_problem)
{
  ...
  ASSERT_EQ(
    problem_expert.getProblem(), std::string("( define ( problem problem_1 )\n( :domain simple ") +
                                   std::string(")\n( :objects\n\tpaco - person\n\tr2d2 - "
...
TEST(problem_expert, get_problem_observe)
{
  ...
  clear_b1.node_type = plansys2_msgs::msg::Node::PREDICATE;
  clear_b1.name = "clear";
...
TEST(problem_expert, add_problem)
{
  ...
  std::string problem_empty_domain_str(
    (std::istreambuf_iterator<char>(problem_empty_domain_ifs)), std::istreambuf_iterator<char>());
  ...
  std::string problem_charging_str(
    (std::istreambuf_iterator<char>(problem_charging_ifs)), std::istreambuf_iterator<char>());
...
TEST(problem_expert, add_problem_observe)
{
  ...
  ASSERT_TRUE(problem_expert.existPredicate(parser::pddl::fromStringPredicate("(ontable b1)")));
  ASSERT_TRUE(problem_expert.existPredicate(parser::pddl::fromStringPredicate("(clear b1)")));
...
TEST(problem_expert, is_goal_satisfied)
{
  ...
  ASSERT_TRUE(
    problem_expert.addPredicate(parser::pddl::fromStringPredicate("(robot_talk leia m1 Jack)")));
