...
/**
 * This function recursively extracts the logic expressions and predicates from
 * the expression.
 *
...
plansys2_msgs::msg::Tree fromString(
  const std::string & expr, bool negate = false, uint8_t parent = plansys2_msgs::msg::Node::NONE);
