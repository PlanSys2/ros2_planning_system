...
namespace parser {
  namespace pddl {
    ...
    fromString(plansys2_msgs::msg::Tree &tree, const std::string &expr, bool negate, uint8_t parent) {
    ...
    plansys2_msgs::msg::Node fromStringPredicate(const std::string &predicate) {
      ...
      tokens[0].erase(0, 1);
      if (tokens[0].at(tokens[0].size()-1) == ')'){ // TODO this is needed when there are no parameters
    ...
    plansys2_msgs::msg::Tree::SharedPtr
    fromSubtrees(const std::vector<plansys2_msgs::msg::Tree> &subtrees, uint8_t node_type) {
      if (node_type != plansys2_msgs::msg::Node::AND && node_type != plansys2_msgs::msg::Node::OR &&
          node_type != plansys2_msgs::msg::Node::NOT) {
    ...
    void
    getSubtreeChildren(plansys2_msgs::msg::Tree &subtree, const plansys2_msgs::msg::Tree &tree, uint32_t tree_parent,
    ...
    void getPredicates(std::vector<plansys2_msgs::msg::Node> &predicates, const plansys2_msgs::msg::Tree &tree,
    ...
    void getFunctions(std::vector<plansys2_msgs::msg::Node> &functions, const plansys2_msgs::msg::Tree &tree,
                      uint32_t node_id, bool negate) {
      if (node_id >= tree.nodes.size()) {
        return;
      }
